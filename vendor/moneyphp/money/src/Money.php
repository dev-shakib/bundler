...
final class Money implements JsonSerializable
{
     ...
     */
    public function multiply(int $multiplier, int $roundingMode = self::ROUND_HALF_UP): Money
    {
     ...
     * @psalm-param self::ROUND_*  $roundingMode
     */
    public function divide(int $divisor, int $roundingMode = self::ROUND_HALF_UP): Money
    {
        if (is_int($divisor)) {
    ...
    public function allocate(array $ratios): array
    {
        ...
        $amount    = $this->amount;
        $fractions = array_map(static function (float $ratio) use ($total, $amount) {
