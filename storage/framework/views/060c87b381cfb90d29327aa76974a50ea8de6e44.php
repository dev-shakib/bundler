                            ...
                            <?php if($user->profile): ?>
                                <?php if(Auth::user()->id == $user->id): ?>
                                    <div class="container">
                                        <div class="row">
                                            <div
                                                class="col-12 col-sm-4 col-md-3 profile-sidebar text-white rounded-left-sm-up">
                                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                                    aria-orientation="vertical">
                                                    <a class="nav-link active" data-toggle="pill" href=".edit-profile-tab"
                                                        role="tab" aria-controls="edit-profile-tab"
                                                        aria-selected="true">
                                            ...
                                            <div class="col-12 col-sm-8 col-md-9">
                                                <div class="tab-content" id="v-pills-tabContent">
                                                    <div class="tab-pane fade show active edit-profile-tab" role="tabpanel"
                                                        ...
                                                        <div class="row mb-1">
                                                            <div class="col-sm-12">
                                                                <div id="avatar_container">
                                                                    <div
                                                                        class="collapseOne card-collapse collapse <?php if($user->profile->avatar_status == 0): ?> show <?php endif; ?>">
                                                                        <div class="card-body">
                                                                            <img src="<?php echo e(Gravatar::get($user->email)); ?>"
                                                                                alt="<?php echo e($user->name); ?>"
                                                                                class="user-avatar">
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        class="collapseTwo card-collapse collapse <?php if($user->profile->avatar_status == 1): ?> show <?php endif; ?>">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <img id="user_selected_avatar"
                                                                                class="user-avatar"
                                                                                src="<?php if($user->profile->avatar != null): ?> <?php echo e($user->profile->avatar); ?> <?php endif; ?>"
                                                                                alt="<?php echo e($user->name); ?>">
                                                                            <?php echo Form::close(); ?>
                                                        ...
                                                        <?php echo Form::model($user->profile, [
                                                            'method' => 'PATCH',
                                                            'route' => ['profile.update', $user->name],
                                                            ...
                                                            <div class="col-10 offset-1 col-sm-10 offset-sm-1 mb-1">
                                                                <div class="row" data-toggle="buttons">
                                                                    <div class="col-6 col-xs-6 right-btn-container">
                                                                        <label
                                                                            class="btn btn-primary <?php if($user->profile->avatar_status == 0): ?> active <?php endif; ?> btn-block btn-sm"
                                                                            data-toggle="collapse"
                                                                            data-target=".collapseOne:not(.show), .collapseTwo.show">
                                                                            <input type="radio" name="avatar_status"
                                                                                id="option1" autocomplete="off"
                                                                                value="0"
                                                                                <?php if($user->profile->avatar_status == 0): ?> checked <?php endif; ?>>
                                                                            Use Gravatar
                                                                        </label>
                                                                    </div>
                                                                    <div class="col-6 col-xs-6 left-btn-container">
                                                                        <label
                                                                            class="btn btn-primary <?php if($user->profile->avatar_status == 1): ?> active <?php endif; ?> btn-block btn-sm"
                                                                            data-toggle="collapse"
                                                                            data-target=".collapseOne.show, .collapseTwo:not(.show)">
                                                                            <input type="radio" name="avatar_status"
                                                                                id="option2" autocomplete="off"
                                                                                value="1"
                                                                                <?php if($user->profile->avatar_status == 1): ?> checked <?php endif; ?>>
                                                                            Use My Image
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div
                                                            class="form-group has-feedback <?php echo e($errors->has('location') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('location', trans('profile.label-location'), ['class' => 'col-12 control-label']); ?>

                                                            <div class="col-12">
                                                                <?php echo Form::text('location', old('location'), [
                                                                    'id' => 'location',
                                                                    'class' => 'form-control',
                                                                    'placeholder' => trans('profile.ph-location'),
                                                                ]); ?>

                                                                <span
                                                                    class="glyphicon <?php echo e($errors->has('location') ? ' glyphicon-asterisk ' : ' glyphicon-pencil '); ?> form-control-feedback"
                                                        ...
                                                        <div
                                                            class="form-group has-feedback <?php echo e($errors->has('bio') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('bio', trans('profile.label-bio'), ['class' => 'col-12 control-label']); ?>

                                                            <div class="col-12">
                                                                <?php echo Form::textarea('bio', old('bio'), [
                                                                    'id' => 'bio',
                                                                    'class' => 'form-control',
                                                                    'placeholder' => trans('profile.ph-bio'),
                                                                ]); ?>
                                                        ...
                                                        <div
                                                            class="form-group has-feedback <?php echo e($errors->has('twitter_username') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('twitter_username', trans('profile.label-twitter_username'), [
                                                                'class' => 'col-12 control-label',
                                                            ]); ?>

                                                            <div class="col-12">
                                                                <?php echo Form::text('twitter_username', old('twitter_username'), [
                                                                    'id' => 'twitter_username',
                                                                    'class' => 'form-control',
                                                                    'placeholder' => trans('profile.ph-twitter_username'),
                                                                ]); ?>
                                                        ...
                                                        <div
                                                            class="margin-bottom-2 form-group has-feedback <?php echo e($errors->has('github_username') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('github_username', trans('profile.label-github_username'), ['class' => 'col-12 control-label']); ?>

                                                            <div class="col-12">
                                                                <?php echo Form::text('github_username', old('github_username'), [
                                                                    'id' => 'github_username',
                                                                    'class' => 'form-control',
                                                                    'placeholder' => trans('profile.ph-github_username'),
                                                                ]); ?>
                                                        ...
                                                        <div class="form-group margin-bottom-2">
                                                            <div class="col-12">
                                                                <?php echo Form::button('<i class="fa fa-fw fa-save" aria-hidden="true"></i> ' . trans('profile.submitButton'), [
                                                                    'id' => 'confirmFormSave',
                                                    ...
                                                    <div class="tab-pane fade edit-settings-tab" role="tabpanel"
                                                        ...
                                                        <?php echo Form::model($user, [
                                                            'action' => ['ProfilesController@updateUserAccount', $user->id],
                                                            'method' => 'PUT',
                                                            'id' => 'user_basics_form',
                                                        ]); ?>
                                                        ...
                                                        <div
                                                            class="pt-4 pr-3 pl-2 form-group has-feedback row <?php echo e($errors->has('name') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('name', trans('forms.create_user_label_username'), ['class' => 'col-md-3 control-label']); ?>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <label class="input-group-text" for="name">
                                                                            <i class="fa fa-fw <?php echo e(trans('forms.create_user_icon_username')); ?>"
                                                                                aria-hidden="true"></i>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div
                                                            class="pr-3 pl-2 form-group has-feedback row <?php echo e($errors->has('email') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('email', trans('forms.create_user_label_email'), ['class' => 'col-md-3 control-label']); ?>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <label for="email" class="input-group-text">
                                                                            <i class="fa fa-fw <?php echo e(trans('forms.create_user_icon_email')); ?>"
                                                                                aria-hidden="true"></i>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div
                                                            class="pr-3 pl-2 form-group has-feedback row <?php echo e($errors->has('first_name') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('first_name', trans('forms.create_user_label_firstname'), ['class' => 'col-md-3 control-label']); ?>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <label class="input-group-text" for="first_name">
                                                                            <i class="fa fa-fw <?php echo e(trans('forms.create_user_icon_firstname')); ?>"
                                                                                aria-hidden="true"></i>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div
                                                            class="pr-3 pl-2 form-group has-feedback row <?php echo e($errors->has('last_name') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('last_name', trans('forms.create_user_label_lastname'), ['class' => 'col-md-3 control-label']); ?>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <label class="input-group-text" for="last_name">
                                                                            <i class="fa fa-fw <?php echo e(trans('forms.create_user_icon_lastname')); ?>"
                                                                                aria-hidden="true"></i>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-md-9 offset-md-3">
                                                                <?php echo Form::button('<i class="fa fa-fw fa-save" aria-hidden="true"></i> ' . trans('profile.submitProfileButton'), [
                                                                    'class' => 'btn btn-success disabled',
                                                    ...
                                                    <div class="tab-pane fade edit-account-tab" role="tabpanel"
                                                        ...
                                                        <ul
                                                            class="account-admin-subnav nav nav-pills nav-justified margin-bottom-3 margin-top-1">
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div id="changepw" class="tab-pane fade show active">
                                                                ...
                                                                <?php echo Form::model($user, [
                                                                    'action' => ['ProfilesController@updateUserPassword', $user->id],
                                                                    'method' => 'PUT',
                                                                ...
                                                                <div class="pw-change-container margin-bottom-2">
                                                                    ...
                                                                    <div
                                                                        class="form-group has-feedback row <?php echo e($errors->has('password') ? ' has-error ' : ''); ?>">
                                                                        <?php echo Form::label('password', trans('forms.create_user_label_password'), ['class' => 'col-md-3 control-label']); ?>
                                                                    ...
                                                                    <div
                                                                        class="form-group has-feedback row <?php echo e($errors->has('password_confirmation') ? ' has-error ' : ''); ?>">
                                                                        <?php echo Form::label('password_confirmation', trans('forms.create_user_label_pw_confirmation'), [
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-md-9 offset-md-3">
                                                                        <?php echo Form::button('<i class="fa fa-fw fa-save" aria-hidden="true"></i> ' . trans('profile.submitPWButton'), [
                                                            ...
                                                            <div id="deleteAccount" class="tab-pane fade">
                                                                ...
                                                                <p class="margin-bottom-2 text-center">
                                                                    ...
                                                                    <u><strong>permanent</strong></u> and
                                                                    <u><strong>cannot</strong></u> be undone.
                                                                    <i class="fa fa-exclamation-triangle fa-fw"
                                                                        aria-hidden="true"></i>
                                                                </p>
                                                                <hr>
                                                                <div class="row">
                                                                    <div
                                                                        class="col-sm-6 offset-sm-3 margin-bottom-3 text-center">

                                                                        <?php echo Form::model($user, ['action' => ['ProfilesController@deleteUserAccount', $user->id], 'method' => 'DELETE']); ?>
                                                                        ...
                                                                        <div class="btn-group btn-group-vertical margin-bottom-2 custom-checkbox-fa"
                                                                            ...
                                                                            <label class="btn no-shadow"
                                                                                ...
                                                                                <i
                                                                                    class="fa fa-check-square-o fa-fw fa-2x"></i>
                                                                                <span class="margin-left-2"> Confirm
                                                                                    Account Deletion</span>
                                                                            </label>
                                                                        </div>

                                                                        <?php echo Form::button('<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i> ' . trans('profile.deleteAccountBtn'), [
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\bundler\resources\views/backend/pages/profiles/edit.blade.php ENDPATH**/ ?>