                        ...
                        <div class="row">
                            <div class="col-sm-4 offset-sm-2 col-md-2 offset-md-3">
                                <img src="<?php if($user->profile && $user->profile->avatar_status == 1): ?> <?php echo e($user->profile->avatar); ?> <?php else: ?> <?php echo e(Gravatar::get($user->email)); ?> <?php endif; ?>"
                                    alt="<?php echo e($user->name); ?>" class="rounded-circle center-block mb-3 mt-4 user-image">
                            </div>
                                ...
                                <?php if($user->profile): ?>
                                    <div class="text-center text-left-tablet mb-4">
                                        ...
                                        <?php echo Form::open([
                                            ...
                                            'title' => trans('usersmanagement.deleteUser'),
                                        ]); ?>

                                        <?php echo Form::hidden('_method', 'DELETE'); ?>

                                        <?php echo Form::button(
                                            '<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i> <span class="hidden-xs hidden-sm hidden-md">' .
                                                trans('usersmanagement.deleteUser') .
                                                '</span>',
                                            [
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\bundler\resources\views/backend/pages/usersmanagement/show-user.blade.php ENDPATH**/ ?>