...
<?php $__env->startSection(config('roles.titleExtended')); ?>
    <?php echo trans('laravelroles::laravelroles.titles.create-role'); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-post" id="post_card">
                    ...
                    <?php echo $__env->make('laravelroles::laravelroles.forms.create-role-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make(config('roles.bladeExtended'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LSKIT\bundler\vendor\jeremykenedy\laravel-roles\src/resources/views//laravelroles/crud/roles/create.blade.php ENDPATH**/ ?>