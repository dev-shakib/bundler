                ...
                <section class="col-lg-12 connectedSortable">
                    <div class="demo">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6">
                                    <form action="<?php echo e(route('payment.paypal')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-6">
                                    <form action="<?php echo e(route('payment.strippe.index')); ?>" method="get">
                                        <input type="hidden" name="amount" value="<?php echo e($price); ?>">
                                        <input type="hidden" name="package_id" value="<?php echo e($package_id); ?>">
...
<?php echo $__env->make('backend.layouts.choosePlan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\bundler\resources\views/backend/pages/plan/payment.blade.php ENDPATH**/ ?>