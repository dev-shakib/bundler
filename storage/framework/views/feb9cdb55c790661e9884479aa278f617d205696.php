    ...
    <div class="main">
        ...
        <section class="">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <img src="<?php echo e(asset('frontend/img/process-1.PNG')); ?>" alt="process" class="w-100 img-fluid">
                    </div><!-- col./  -->
                </div><!-- row./  -->
            </div><!-- container./  -->
        </section>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\bundler\resources\views/frontend/homepage.blade.php ENDPATH**/ ?>