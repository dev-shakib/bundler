                                ...
                                <table class="table table-striped table-sm data-table">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-xs hidden-sm"><?php echo trans('usersmanagement.users-table.role'); ?></th>
                                            <th class="hidden-xs"><?php echo trans('usersmanagement.labelDeletedAt'); ?></th>
                                            <th class="hidden-xs"><?php echo trans('usersmanagement.labelIpDeleted'); ?></th>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\bundler\resources\views/backend/pages/usersmanagement/show-deleted-users.blade.php ENDPATH**/ ?>