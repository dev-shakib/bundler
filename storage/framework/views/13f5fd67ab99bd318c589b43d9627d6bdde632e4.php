                                    ...
                                    <?php $__currentLoopData = $bundle->generated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="<?php echo e(route('bundle.generated.destroy', [$b->id])); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\bundler\resources\views/backend/pages/bundle/generated_bundle.blade.php ENDPATH**/ ?>