            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <section class="col-lg-12 connectedSortable">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo e(route('public.bundle.files.store')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bundler\resources\views/backend/pages/bundle/files/create.blade.php ENDPATH**/ ?>