                        ...
                        <tbody>
                            <?php $__currentLoopData = $bundle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="clickable-row"
                                    data-href="<?php echo e(route('bundle.show_single', [$b->slug, $b->id])); ?>">
                                    <a href="">
                                        ...
                                        <td class="py-1 pl-3 align-middle"><?php echo e($b->formatdate()); ?></td>
                                        ...
                                        <td class="py-1 pl-3 align-middle text-right">
                                            <a title="View"
                                                href="<?php echo e(route('bundle.show_single', [$b->slug, $b->id])); ?>"
                                            ...
                                            <form title="Delete" action="<?php echo e(route('bundle.destroy', [$b->id])); ?>"
